...
function constructDocument(method) {
    ...
    method.descriptor.value = function(...args) {
        ...
        const document = Object.assign({}, new DocumentType(...args))
...
module.exports = { exposeCollection, exposeDocument, filter, constructDocument, makeDocument, documentSet, normalizeSelector }
